...
export default class Grid {
   ...
   */
  get (row, column) {
    return this.array[this.getIndex(row, column)]
  }
  ...
  set (row, column, value) {
    this.array[this.getIndex(row, column)] = value
    return this
  }
  ...
  getCoordinates (index) {
    ...
    this.lastCoordinates.column =
      index - (this.lastCoordinates.row << this.offset)
